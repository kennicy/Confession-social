...
export default function ProfileComponent({ user, profile, setProfile }) {
  ...
  return (
    <div style={{ minHeight: "10vh", backgroundColor: "#f4f6f8", display: "flex", justifyContent: "center", alignItems: "center", padding: "10px 20px" }}>
      <div style={{ width: "100%", maxWidth: "700px", backgroundColor: "#fff", borderRadius: "25px", boxShadow: "0 12px 24px rgba(0,0,0,0.15)", padding: "40px 30px", display: "flex", flexDirection: "column", gap: "30px" }}>
