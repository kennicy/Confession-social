...
export default function MessageList({ user, allUsers, selectedUser, messages, setMessages, messagesEndRef }) {
  ...
  return (
    <div className="flex-1 p-3 overflow-y-auto flex flex-col gap-2 bg-gray-50 relative">
              ...
              <div className="relative group max-w-[70%] flex items-start">
                {isMe && (
                  <button
                    ...
                    className="mr-1 opacity-0 group-hover:opacity-100 bg-gray-200 hover:bg-red-400 text-red-600 rounded-full p-1 transition-all"
                  >
                    <Trash2 size={14} />
                  </button>
                )}
                    ...
                    <div className="mt-2">
                      {m.type === "image" ? (
                        <img
                          ...
                          onClick={() => setPreviewImage(m.image_url)} // click show modal
                        />
                      ) : (
      ...
      {confirmDeleteId && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50">
          <div className="bg-white p-4 rounded shadow-md flex flex-col gap-3 w-64">
            <span className="text-gray-700 text-center">Delete this message?</span>
